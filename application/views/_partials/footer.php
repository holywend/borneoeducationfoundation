    ...
    <div class="container">
        <div class="row">
            <div class="col m6 s12">
                <h5 class="white-text">Foundation Bio</h5>
            ...
            <div class="col m3 s12">
                <h5 class="white-text">Sponsor Me</h5>
                <ul>
                    <li><a class="white-text" href="#!">Child 1</a></li>
                    <li><a class="white-text" href="#!">Child 2</a></li>
                    <li><a class="white-text" href="#!">Child 3</a></li>
                    <li><a class="white-text" href="#!">Child 4</a></li>
                </ul>
            </div>
        </div>
    </div>
